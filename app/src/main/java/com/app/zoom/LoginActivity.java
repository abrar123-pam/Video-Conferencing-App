...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private EditText editTextPassword, edittextphone,edittextGENRATE;
    private TextView textViewCancel;
    private TextView textViewTitle;
    private AppCompatButton buttonSignIn, sendbtn,logbtn;
    ...
    private void initViews() {
        ...
        edittextGENRATE = (EditText) findViewById(R.id.edittextgenerate);
        ...
        logbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edittextGENRATE.getText().toString())) {
                    ...
                    verifyCode(edittextGENRATE.getText().toString());
                }
            }
        });
    }
    ...
    private QBUser createUserWithEnteredData(String userId,String name) {
        return createQBUserWithCurrentData(userId, name);
    }
    ...
    private void signInWithCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            userForSave = createUserWithEnteredData(edittextphone.getText().toString(),edittextGENRATE.getText().toString());
                            startSignUpNewUser(userForSave);
...
//                  edittextGENRATE.setEnabled(true);
