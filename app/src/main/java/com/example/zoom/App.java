...
public class App extends Application {
    //App credentials
    private static final String APPLICATION_ID = "97955";
    private static final String AUTH_KEY = "uq9CzKKWOa2hZxp";
    private static final String AUTH_SECRET = "dN8KTzG9E3jmue9";
    private static final String ACCOUNT_KEY = "yBxpxxC6k9k5ryfBy-kr";
